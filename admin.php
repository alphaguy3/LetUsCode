...
<html lang=''>
  <head>
   ...
   function startcontest(id)
   {
      ...
      function(data)
      {
          if(data=="success")
          {
             alert("Contest Has Been Started");
          }
          else
          {
             alert("Error Starting Contest. Please Try Again");
          }
      });
   }
   ...
   function endcontest(id)
   {
          ...
          function(data)
          {
               if(data=="success")
               {
                 alert("Contest Has Been Stopped");
               }
               else
               {
                alert("Error Ending The Contest. Please Try Again");
               }
          });
   }
       ...
       $.post("getlivecontests.php",
        ...
        function(data)
        {
             ...
             for(i=0;i<length;i++)
             {
                   ...
                   innerhtml +=  "<div class=\"list-group-item col-xs-12 nop\" style=\"background:lavender\"> <div class=\"col-xs-9 no\" style=\"padding:15px\">  <h4 class=\"list-group-item-heading hdd4\">"+ans[i]["name"]+"</h4>  <p class=\"list-group-item-text\">"+ans[i]["description"]+"</p> </div> <div class=\"col-xs-1 delcol no\">  <center><a href=editcontest.php?cid="+ans[i]['id']+"><button  class=\"btn editbtn\"><i class=\"fa fa-pencil\"></i></button></a></center> </div>  <div class=\"col-xs-2  enterdiv\">   <center><a href=\"leaderboard.php?cid="+ans[i]['id']+"\">Leaderboard<i class=\"fa fa-arrow-right\"></i></a></center></div></div>   <button onclick='endcontest("+ans[i]['id']+")' class=\"col-xs-2  enterdiv\">   <center>End Contest</center></button></div>";
             } 
 ...
 //   var user = '<?php //echo $userid; ?>';
    ...
    function(data)
    {
        ...
        for(i=0;i<length;i++)
        {
          innerhtml += "<div class=\"list-group-item col-xs-12 nop\" style=\"background:lavender\"><div class=\"col-xs-8 no\" style=\"padding:15px\"> <h4 class=\"list-group-item-heading hdd4\">"+ans[i]['name']+"</h4>  <p class=\"list-group-item-text\">"+ans[i]['description']+"</p></div><div class=\"col-xs-1 editcol no\"> <center><a href=editcontest.php?cid="+ans[i]['id']+"><button class=\"btn editbtn\"><i class=\"fa fa-pencil\"></i></button></a></center></div> <div class=\"col-xs-1 delcol no\"> <center><button class=\"btn delbtn\"><i class=\"fa fa-close\"></i></button></center>   </div>      <div class=\"col-xs-2  startsatdiv\">        <center><div class=\"col-xs-12 no\"><center><p style=\"font-size:18px\"><b>Date:</b></p></center></div><div class=\"col-xs-12 no\"><p>"+ans[i]['date']+"</p></div></center>      </div>    </div>";
        }
  ...
  function gettodayscontests()
  {
    ...
    function(data)
    {
        ...
        for(i=0;i<length;i++)
        {
          innerhtml += "<div class=\"list-group-item col-xs-12 nop\" style=\"background:lavender\"><div class=\"col-xs-8 no\" style=\"padding:15px\"> <h4 class=\"list-group-item-heading hdd4\">"+ans[i]['name']+"</h4>  <p class=\"list-group-item-text\">"+ans[i]['description']+"</p></div><div class=\"col-xs-1 editcol no\"> <center><a href=editcontest.php?cid="+ans[i]['id']+"><button class=\"btn editbtn\"><i class=\"fa fa-pencil\"></i></button><a></center></div> <div class=\"col-xs-1 delcol no\"> <center><button class=\"btn delbtn\"><i class=\"fa fa-close\"></i></button></center>   </div>      <div class=\"col-xs-2  startsatdiv\">        <center><button class=\"col-xs-12 no\"><center><p onclick='startcontest("+ans[i]['id']+")' style=\"font-size:18px\"><b>Start</b></p></center></button></center>  </div>  </div>";
        }
    ...
    <div class="container-fluid" style="background:;height:100%;">
      ...
      <nav class="navigation">
        <ul class="list-unstyled">
          <li class="active"><a href="#"><i class="fa fa-cog"></i><span class="nav-label">Conduct Contest</span></a></li>
        ...
        <div class="col-md-3 col-xs-4 profileimgdiv">
          <div class="row">
            ...
            <div class="col-md-7 col-xs-7 col-md-offset-1 col-xs-offset-1 no">
              <div class="col-md-12 col-xs-12 name nom"><h4 class="nom" style="margin-top:15%;">Admin</h4></div>
              <div class="col-md-12 col-xs-12 email"><p>admin@letuscode.in</p></div>
            </div>
          </div>
        </div>
...
<div class="col-xs-6 col-xs-push-3">
  ...
  <form class="form-horizontal" method="post" action="add_contest.php">
    ...
    <div class="col-xs-12">
      ...
      <div class="form-group col-xs-4">
        <label class="col-sm-2 control-label no">Duration</label>
        <div class="col-sm-10">
          <input type="number" class="form-control floating-label" id="dur_hrs" name="dur_hrs" placeholder="Hours" required>
          <input type="number" class="form-control floating-label" id="dur_hrs" name="dur_min" placeholder="Minutes" required>
        </div>
      </div>
      <div class="form-group col-xs-4">
        <label class="col-sm-2 control-label no">Password</label>
        <div class="col-sm-10">
          <input type="number" class="form-control floating-label" id="password" name="password" placeholder="Password" required>
        </div>
      </div>
    </div>
    <div class="col-sm-12">
    ...
    <script type="text/javascript">
    setInterval(function(){getlivecontests();},1000);
    setInterval(function(){getupcomingcontests()},1000);
    setInterval(function(){gettodayscontests()},1000);
    </script>
  </html>