        ...
        console.log('called');
         $.get("getlivecontestsforusers.php",
          function(data)
          {
                ...
                for(i=0;i<length;i++)
                {
                    innerhtml += "<div class=\"list-group-item col-xs-12 nop\" style=\"background:lavender\"><div class=\"col-xs-9 no\" tyle=\"padding:15px\"><h4 class=\"list-group-item-heading hdd4\">"+ans[i]['name']+"</h4><p class=\"list-group-item-text\">"+ans[i]['description']+"</p></div><div class=\"col-xs-3  enterdiv\"><center><a href=\"entertest.php?cid="+ans[i]['id']+"\">Enter<i class=\"fa fa-arrow-right\"></i></a></center></div></div>";
                }
       ...
       function getupcomingcontests()
      {
         $.get("getupcomingcontestforusers.php",
          function(data)
          {
                ...
                for(i=0;i<length;i++)
                {
                    innerhtml += "<div class=\"list-group-item col-xs-12 nop\" style=\"background:lavender\"><div class=\"col-xs-9 no\" tyle=\"padding:15px\"><h4 class=\"list-group-item-heading hdd4\">"+ans[i]['name']+"</h4><p class=\"list-group-item-text\">"+ans[i]['description']+"</p></div><div class=\"col-xs-3  enterdiv\"><center>Date:"+ans[i]['date']+"<i class=\"fa fa-arrow-right\"></i></center></div></div>";
                }
         ...
         function getpastcontests()
      {
         $.get("getpastcontestsforusers.php",
          function(data)
          {
                ...
                for(i=0;i<length;i++)
                {
                    innerhtml += "<div class=\"list-group-item col-xs-12 nop\" style=\"background:lavender\"><div class=\"col-xs-9 no\" tyle=\"padding:15px\"><h4 class=\"list-group-item-heading hdd4\">"+ans[i]['name']+"</h4><p class=\"list-group-item-text\">"+ans[i]['description']+"</p></div><a href=\"#\"><div class=\"col-xs-3  enterdiv\"><center>LeaderBoard<i class=\"fa fa-arrow-right\"></i></center></div></a></div>";
                }
